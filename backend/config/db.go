...
func createSeedData(db *gorm.DB) {
	...
	verifies := []entity.Verify{
		{VerificationDocument: "/uploads/verifyDocument/001.png", StatusVerifyID: 2, UserID: 2},
		{VerificationDocument: "/uploads/verifyDocument/002.pdf", StatusVerifyID: 2, UserID: 6},
		{VerificationDocument: "/uploads/verifyDocument/001.png", StatusVerifyID: 2, UserID: 4},
		{VerificationDocument: "/uploads/verifyDocument/002.pdf", StatusVerifyID: 2, UserID: 14},
	}
