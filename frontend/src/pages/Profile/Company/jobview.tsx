  ...
  return (
    <div className="animation-scroll">
      <Card
        ...
        // 🔒 แสดงปุ่มใน actions เฉพาะนักศึกษา
        actions={
          isStudent
            ? [
                <Button
            ...
            : [
                // ถ้าอยากให้เห็นปุ่มแต่กดไม่ได้ ใช้ Tooltip + disabled
                <Tooltip key="locked" title="เฉพาะนักศึกษาจึงจะสมัครได้">
                  <Button
                    type="primary"
                    size="large"
                    disabled
        ...
        <Card.Meta
          title={
            <div>
              ...
              <Tag
                color={
                  job.WorkMode?.work_mode === 'Remote'
                    ? '#1890ff'
                    : job.WorkMode?.work_mode === 'On-site'
                    ? '#52c41a'
                    : job.WorkMode?.work_mode === 'Hybrid'
                    ? '#fa8c16'
                    : '#d9d9d9'
                }
                style={{
