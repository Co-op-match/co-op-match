...
export interface StepAcadamicStaffAddressProps {
...
const StepAddress: React.FC<StepAcadamicStaffAddressProps> = ({ form }) => {
  // raw data จาก API
        ...
        <Col span={12}>
          ...
          >
            <Select
              ...
              allowClear
              onChange={() => form.setFieldsValue({ post_code: undefined })}
              onClear={() => form.setFieldsValue({ subdistrict_id: undefined, post_code: undefined })}
            />
          </Form.Item>
        </Col>
